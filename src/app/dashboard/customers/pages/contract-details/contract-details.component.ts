...
export class ContractDetailsComponent {
  ...
  ngOnInit(): void {
    this.activatedRoute.params
      ...
      this.createWorkOrder =  ((permissionsWorkOrder as number >> 1 ) % 2 == 1)? true :false; 
  ...
  async downloadPDF() {
    const resp = await this.contractsService.downloadPDF( +this.contract.id );
    window.open(`${this.fileUrl}/uploads/docs/contracts/${resp.pdfName}`, '_blank');
  }
