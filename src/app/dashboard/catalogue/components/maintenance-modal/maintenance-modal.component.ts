...
export class MaintenanceModalComponent implements OnInit {
  ...
  async create() {
    ...
    this.maintenanceService.create({...this.form.value, workToolId: this.workToolId, isCurrent: true})
      .subscribe({
        next: ( resp ) => {
          Swal.fire({
            text: resp.message,
  ...
  async update() {
    this.maintenanceService.update( this.maintenance.id, {...this.form.value, workToolId: this.workToolId})
      .subscribe({
        next: ( resp ) => {
          Swal.fire({
            text: resp.message,
