...
@Component({
  selector: 'html-descriptions-modal-product',
  templateUrl: './html-descriptions-modal-product.component.html',
  styleUrls: ['./html-descriptions-modal-product.component.scss']
})
export class HtmlDescriptionsModalProductComponent {
